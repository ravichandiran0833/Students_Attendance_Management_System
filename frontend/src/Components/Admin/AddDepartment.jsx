  ...
  return (
    <>
      <div className="relative w-full min-h-screen">
        {loading.addDepartment && (
          <div className="absolute inset-0 z-50 flex items-center justify-center bg-white/20">
            <Loading />
          </div>
        )}
        <div
          className={`w-full min-h-screen flex flex-col items-center py-6 md:py-10 px-4 bg-gray-400 transition-opacity duration-300 ${loading.addDepartment ? "opacity-50 pointer-events-none" : "opacity-100"}`}
        >
          ...
          <div className="w-70 md:w-xl lg:w-2xl bg-transparent shadow-[0_0_5px_whitesmoke] lg:shadow-[0_0_20px_whitesmoke] border border-gray-300 rounded">
            ...
            >
              ...
              <button
                ...
                disabled={loading.addDepartment}
              >
                {loading.addDepartment ? "Adding..." : "Add Department"}
              </button>
            </form>
          </div>
        </div>
